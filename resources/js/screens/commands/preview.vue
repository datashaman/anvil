        ...
        <div slot="after-attributes-card" slot-scope="slotProps">
            <div class="card mt-5">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" :class="{active: currentTab=='form-definition'}" href="#" v-on:click.prevent="currentTab='form-definition'">Form Definition</a>
                    </li>
                    <li class="nav-item">
                ...
                <div>
                    ...
                    <div class="code-bg p-4 mb-0 text-white" v-show="currentTab=='form-definition'">
