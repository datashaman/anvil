    ...
    <preview-screen title="Mail Details" resource="mail" :id="$route.params.id">
        <template slot="table-parameters" slot-scope="slotProps">
            ...
            <tr>
                ...
                <td>
                    <a :href="Anvil.basePath + '/anvil-api/mail/'+$route.params.id+'/download'">Download .eml file</a>
                </td>
            </tr>
        </template>

        <div slot="after-attributes-card" slot-scope="slotProps" class="mt-5">
            <iframe :src="Anvil.basePath + '/anvil-api/mail/'+$route.params.id+'/preview'" width="100%" height="400"></iframe>
        </div>
    </preview-screen>
</template>
